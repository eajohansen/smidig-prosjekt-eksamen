      ...
      <div className="UserProfileContainer">
        ...
        <div className="profileInfoContainer inputHover">
          <div className="userInfoContainer">
            ...
            <a className="chageLogIn chageEM" href="">
              Endre E-post
            </a>
            <a className="chageLogIn" href="">
              Endre passord
            </a>
          </div>
          <div className="allergyContainer">
            ...
            <div className="allergyBtnDiv">
              <input type="text" id="allergyInput" name="allergier" />
              <button className="addBtn">Legg til</button>
            </div>
            ...
            <label className="moreInfoTxt" htmlFor="moreInfo">
              Ønsker du å oppgi annen viktig informasjon om deg selv?
            </label>
            ...
            <div className="disclaimerDiv">
              ...
              <label className="disclaimer">
                ...
                informasjonen kan deles med arrangør og eventuelle
                medarrangører.
              </label>
            </div>
